...
namespace Native.Csharp.App.Export
{
	...
	{	
		...
		{	
			...
			type.GetProperty ("Version", BindingFlags.Public | BindingFlags.Static).SetMethod.Invoke (null, new object[] { new Version ("0.0.2") });	
		...
		{	
			return "9,me.cqp.ritsukage.RitsukageBot";	
		}	
